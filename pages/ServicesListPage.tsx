...
const ServicesListPage: React.FC = () => {
    ...
    return (
        <div className="flex flex-col lg:flex-row min-h-screen bg-white dark:bg-background-dark text-[#181111] dark:text-[#f0f0f0] font-display">
            <Sidebar />
            <main className="flex-1 lg:ml-56 relative bg-white dark:bg-background-dark min-h-screen">
                ...
                <section className="px-6 lg:px-20 pb-20">
                    <div className="relative w-full h-[300px] md:h-[400px] rounded-sm overflow-hidden max-w-7xl mx-auto group">
                        <img
                            src="https://lh3.googleusercontent.com/aida-public/AB6AXuCOtTkJmb-K77f-mF5JkmaxzLPVRpv_bP3FkP2VUtFV_TvQV9olJODihcCuOSEHD4-mMpIYePiaIBZK6tx8bCfgQCidfs0pkt9Lr-osaqI-gx6poSqmJdNaoV2YR6cbRtpL-rBBh6LBBVPQ9fBjLqBzDDmHr-LIRaTUNpnmayUKBSTDD2iwRK_66Q-3wQz-jhqKNvCZItKrj3yYwTo5QUPuAmdu4xi0ZN0rqg0hVoagMd2oAgfkQaiq2YUiVFdwb94sdBTHUOgcxAWf"
                            alt="Abstract Red Art"
